...
# Como instalar o tema adminbs5_v7
1. copie a pasta pasta `adminbs5_v7` dentro de adianti template cole em `<SISTEMA>/app/templates`
...
altere o valor `theme = <NOME ATUAL>` para `theme = adminbs5_v7`
...
incluido adminbs5_v7 logo abaixo adminbs5, ficando como o exemplo abaixo
```php
